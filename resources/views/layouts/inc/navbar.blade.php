...
<header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-blue-600 text-sm py-3 sm:py-0">
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        ...
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-semibold text-white" href="/" aria-label="Brand">Purbalingga Farm</a>
            <div class="sm:hidden">
                <button type="button"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end py-2 md:py-0 sm:ps-7">
                <a class="py-3 ps-px sm:px-3 font-medium text-white" href="/" aria-current="page">Informasi</a>
                <a class="py-3 ps-px sm:px-3 font-medium text-white" href="daftar" aria-current="page">Daftar</a>
                @auth
                    <a class="py-3 ps-px sm:px-3 font-medium text-white" href="dashboard" aria-current="page">Dashboard</a>
